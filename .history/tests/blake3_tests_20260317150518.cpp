...
bool Blake3Test_Hash256_KnownAnswer_Abc() {
    ...
    // Print actual hash to compare
    for (auto b : *result) printf("%02x", b);
    printf("\n");

    const Hash expected = {{
        0x6d, 0xa1, 0x3d, 0x4f, 0x4d, 0x64, 0xce, 0xb9,
        0x49, 0x27, 0x45, 0xce, 0x44, 0x46, 0x08, 0x35,
        0x8e, 0xca, 0xa3, 0xfe, 0x6e, 0x55, 0x22, 0xa8,
        0x61, 0x14, 0x7d, 0x62, 0xa5, 0x46, 0x60, 0x25
    }};
