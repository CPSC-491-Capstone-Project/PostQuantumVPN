...
bool IPv4Test_HostNetworkRoundtrip() {
    ...
    // Reconstruct: treat net as if it came off the wire
    // On big-endian this is identity; on little-endian it byteswaps twice
...
bool IPv4Test_Constants() {
    // These are consteval — evaluated at compile time
...
bool IPv4Test_FullyConstexpr() {
    // Verify the entire chain works at compile time
    ...
    // If any of these weren't truly constexpr the test wouldn't compile
